...
USER_SERVICE_ROLE_ARN=${USER_SERVICE_ROLE_ARN-'arn:aws:iam::974860574511:role/eks-user-service-role'}
...
CONTAINER_REPOSITORY=${CONTAINER_REPOSITORY-'user-service'}
...
kustomize edit set image user-service=${CONTAINER_REGISTRY}/${CONTAINER_REPOSITORY}:${IMAGE_TAG}
popd
